...
public class Main {
	...
	public static void main(String[] args) {
		...
		System.out.println(h.containsKey(lookup));//requires overide equals and hash method in pair class to work
		System.out.println(h.get(lookup));//requires overide equals and hash method in pair class to work
		System.out.println(lookup.equals(key1));//requires overide equals and hash method in pair class to work
	}
