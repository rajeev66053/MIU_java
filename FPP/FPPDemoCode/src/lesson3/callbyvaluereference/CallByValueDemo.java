 ...
 * Once you invoke a method,it will be stored in the lesson9.stack. 
 * Once the method return,it will be removed from the lesson9.stack.
 * Stack are works like a local variable. 
 * Its scope is inside the lesson9.stack.
