...
class LinkedQueue {
	...
	public void insert(Object item) {
		...
		if (front == null)
		// lesson9.queue is empty; insert first item
		{
			front = rear = p;
			front.next = null;
		}
		if (front == rear)
		// lesson9.queue contains one item; insert second item
		{
			rear = p;
			front.next = rear;
			rear.next = null;
		} else
		// lesson9.queue contains 2 or more items
		{
			rear.next = p;
