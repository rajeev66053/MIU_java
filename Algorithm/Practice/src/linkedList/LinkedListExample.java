...
class LinkedListExample{
	...
	LLNode reverse(LLNode head)
	{
		...
		System.out.println("curLNode");
		System.out.println((curLNode !=null)?curLNode.data:null);
		while(curLNode!=null)
		{
			nextLNode=curLNode.next;
			System.out.println("nextLNode");
			System.out.println((nextLNode != null)?nextLNode.data:null);
			curLNode.next=prevLNode;
			System.out.println("curLNode.next");
			System.out.println((curLNode.next != null)?curLNode.next.data:null);
			
			prevLNode=curLNode;
			System.out.println("prevLNode");
			System.out.println((prevLNode != null)?prevLNode.data:null);
			curLNode=nextLNode;
			System.out.println("curLNode");
			System.out.println((curLNode != null)?curLNode.data:null);
		}
		...
		System.out.println((head != null)?head.data:null);
		return head;
	}
